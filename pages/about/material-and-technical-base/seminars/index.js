...
const Seminars = ({ newsArr, aboutItems, specialitiesItems, bachelorItems, masterItems }) => {
  ...
  const filteredArray = newsArr.filter(item => item.seninars);
  ...
  return (
    <>
      ...
      {/* <!-- ======= Breadcrumbs ======= --> */}
      <Breadcrumbs chapterTitle="Про кафедру" pageTitle="Матеріально-технічна база" subPageUrl="seminars" subPageTitle="Семінари" />
