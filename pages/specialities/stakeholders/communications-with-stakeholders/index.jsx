...
const CommunicWithSH = ({ newsArr, mainMenuQO }) => {
  console.log("newsArr :>> ", newsArr);
  // Фільтрую масив і залишаю лише ті новини, що містять поле communicWithSHBool
  const filteredArray = newsArr.filter((item) => item.communicWithSHBool);
  ...
  return (
    <>
      <Head>
        <title>
          Кафедра електричної інженерії ТНТУ :: Комунікації зі стейкхолдерами{" "}
        </title>
      </Head>
