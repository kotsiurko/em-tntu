...
const ConferenceNews = ({ newsArr, mainMenuQO }) => {
  // Фільтрую масив і залишаю лише ті новини, що містять поле conferenceLEandPEBool
  const filteredArray = newsArr.filter((item) => item.conferenceLEandPEBool);
  ...
  return (
    <>
      <Head>
        <title>Кафедра електричної інженерії ТНТУ :: Зустрічі</title>
      </Head>
