  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Кафедра Електричної Інженерії Тернопільського національного технічного університету імені Івана Пулюя. Спеціальність G3 - Електрична інженерія"
        />
      </Head>
            ...
            <div className="row">
              <div className="col-lg-6 d-flex flex-column justify-content-center">
                ...
                <h2 data-aos="fade-up" data-aos-delay="400">
                  Спеціальність G3 <br /> &ldquo;Електрична інженерія&rdquo;
                </h2>
                <br />
