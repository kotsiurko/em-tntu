...
const PostgraduateStudyPage = ({ postgraduateStudyData, mainMenuQO, newsArr }) => {
  ...
  const { title, body, positionNumber, slug, postGraduateStudentArray } = postgraduateStudyData;
  ...
  return (
    <>
      ...
      {/* < !-- ======= Features Section ======= --> */}
      {body && <section className="features my-personal">
